    ...
    <fieldset class="form" style="width: 420px;">
        ...
        <div class="data-fields">
            <div class="fieldcontain required">
                ...
                <g:textField style="float: right;"  name="CADName"  required="false"/>
            </div>
            ...
            <div class="fieldcontain required">
                ...
                <g:textField style="float: right;"  name="elementSize"  required="false"/>
            </div>
            ...
            <div class="fieldcontain required">
                ...
                <g:textField style="float: right;"  name="deflection"  required="false"/>
            </div>
        </div>
    </fieldset>
